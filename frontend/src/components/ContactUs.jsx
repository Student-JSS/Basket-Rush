...
const ContactUs = () => {
  ...
  // IMPORTANT: put your real WhatsApp number in international format (country code + number),
  // without + or spaces. Example for India: "91xxxxxxxxxx"
  ...
  const handleSubmit = (e) => {
    ...
    // Use web.whatsapp.com/send with phone param (international format, no +)
